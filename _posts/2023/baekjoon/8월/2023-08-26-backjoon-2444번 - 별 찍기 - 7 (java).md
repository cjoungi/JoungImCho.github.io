---
title: "[BaekJoon] 2444번 - 별 찍기 - 7 (java)"
...
permalink: /baekjoon/2444번 - 별 찍기 - 7 (java)/
...
일단 바깥쪽 for 문을 2개로 나눠 별이 증가하는 for 문과 감소하는 for 문을 따로 작성한다.<br>

◾ 별이 증가하는 for 문은 <code><b>int i = 0 부터 i < N</b></code> 까지 loop를 돌린다.<br>
